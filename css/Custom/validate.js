...
(function (a, b, c) {
    ...
    e.extend = function (a) {
        ...
        presence: function (a, b) {
            if (b = e.extend({}, this.options, b), b.allowEmpty !== !1 ? !e.isDefined(a) : e.isEmpty(a)) return b.message || this.message || "debe estar completo"
        },
        ...
        email: e.extend(function (a, b) {
            b = e.extend({}, this.options, b);
            var c = b.message || this.message || "no es un formato valido de e-mail";
